...
- **`main.py`** → The Streamlit-based web application that provides the user interface for interaction.
- **`titanic_model.py`** → Python script to train and save the Titanic survival prediction model.
- **`titanic_model.pkl`** → Serialized machine learning model used for making predictions in the web app.
...
### **✨ Features:**  
- ✔️ **User-friendly UI** with enhanced CSS styling  
- ✔️ **Live prediction updates** using the trained `.pkl` file  
- ✔️ **Interactive sliders and dropdowns** for easy input selection
